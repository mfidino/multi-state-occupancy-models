...
jpeg("./figures/alm_logit_mcmc.jpeg", quality = 100,
...
pred_covs <- list(
  beta23 = cbind(1, seq(-2.75, 2.75,0.05)),
...
x <- pred_covs$beta23[,2]

jpeg(
  "./figures/alm_logit_states.jpeg",
  width = 750,
  height = 550,
  quality = 100,
  pointsize = 17
...
par(fg = "black",lend = 0)
legend(
  "topleft", c("Absent", "Present, not breeding", "Present & breeding"),
  lwd = 3,
  col = c(
    my_cols[1],
    my_cols[2],
...
jpeg("./figures/alm_logit_transitions.jpeg",
